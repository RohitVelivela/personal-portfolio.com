...
import { FiBarChart2, FiCpu, FiGithub, FiLinkedin, FiMail } from 'react-icons/fi';
import { SkillCategory, Experience, SocialLink, NavItem } from '@/types';
...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: 'MATLAB', proficiency: 75, icon: <img src="/matlab_icon.webp" alt="MATLAB" className="w-6 h-6" /> },
